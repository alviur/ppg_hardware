...
//	dataBuffer[1] = Data;	
	...
	returnValue = HAL_I2C_Master_Transmit(&hi2c1,(uint8_t)(deviceAddr),&Reg, 1,100);
  ...
  // i.e. SPI_Mems_Write_Reg(Reg, Data);
    //I2C_ByteWrite(&Data,  deviceAddress,  WriteAddr);
	  ...
	  uint8_t dataBuffer[2] = {0, 0};
		...
		dataBuffer[1] = Data;
		returnValue = HAL_I2C_Master_Transmit(&hi2c1,(uint8_t)(deviceAddress),dataBuffer, 2,100);  
