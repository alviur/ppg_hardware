...
/* Includes ------------------------------------------------------------------*/
#include "C:\Users\Lex-alviur\Desktop\New folder\lis331dlh_driver.h"
...
/*******************************************************************************
* Function Name		: LIS331_Init
* Description		: 			
* Input			: I2C_HandleTypeDef  pointer
* Output		: void
* Return		: void
*******************************************************************************/
void LIS331_Init( I2C_HandleTypeDef hi2c ){
...
//	u8_t dataBuffer[2] = {0, 0};
//	dataBuffer[0] = Reg;
//	dataBuffer[1] = Data;	
	HAL_StatusTypeDef returnValue;


	returnValue = HAL_I2C_Master_Transmit(&LIS331_I2C,(uint8_t)(deviceAddr),&Reg, 1,100);
...
//			1,100);	
	...
	if(returnValue == HAL_OK){
			...
			HAL_I2C_Master_Receive(&LIS331_I2C,
					(uint8_t)(deviceAddr),
					Data,
					1,100);			
...
* Return		: Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
u8_t LIS331DLH_WriteReg(uint8_t deviceAddress, uint8_t WriteAddr, uint8_t Data) {
  ...
  // i.e. SPI_Mems_Write_Reg(Reg, Data);
    //I2C_ByteWrite(&Data,  deviceAddress,  WriteAddr);
	  ...
	  uint8_t dataBuffer[2] = {0, 0};
		dataBuffer[0] = WriteAddr;
		dataBuffer[1] = Data;
		returnValue = HAL_I2C_Master_Transmit(&LIS331_I2C,(uint8_t)(deviceAddress),dataBuffer, 2,100);  
